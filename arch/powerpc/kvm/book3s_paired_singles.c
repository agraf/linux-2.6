...
static int kvmppc_emulate_paired_single(struct kvm_run *run, struct kvm_vcpu *vcpu)
{
...
static int kvmppc_emulate_ps_x(struct kvm_vcpu *vcpu, int rs, int ra, int rb,
			       int rc)
{
	/* the emulate function finds everything itself */
	return kvmppc_emulate_paired_single(vcpu->run, vcpu);
}

static int kvmppc_emulate_ps_d(struct kvm_vcpu *vcpu, int rs, int ra, int d)
{
	/* the emulate function finds everything itself */
	return kvmppc_emulate_paired_single(vcpu->run, vcpu);
}

void __init kvmppc_emulate_paired_singles_init(void)
{
	kvmppc_emulate_register_d(OP_PSQ_L, 0, kvmppc_emulate_ps_d);
	kvmppc_emulate_register_d(OP_PSQ_LU, 0, kvmppc_emulate_ps_d);
	kvmppc_emulate_register_d(OP_PSQ_ST, 0, kvmppc_emulate_ps_d);
	kvmppc_emulate_register_d(OP_PSQ_STU, 0, kvmppc_emulate_ps_d);
	kvmppc_emulate_register_d(OP_LFS, 0, kvmppc_emulate_ps_d);
	kvmppc_emulate_register_d(OP_LFSU, 0, kvmppc_emulate_ps_d);
	kvmppc_emulate_register_d(OP_LFD, 0, kvmppc_emulate_ps_d);
	kvmppc_emulate_register_d(OP_LFDU, 0, kvmppc_emulate_ps_d);
	kvmppc_emulate_register_d(OP_STFS, 0, kvmppc_emulate_ps_d);
	kvmppc_emulate_register_d(OP_STFSU, 0, kvmppc_emulate_ps_d);
	kvmppc_emulate_register_d(OP_STFD, 0, kvmppc_emulate_ps_d);
	kvmppc_emulate_register_d(OP_STFDU, 0, kvmppc_emulate_ps_d);
